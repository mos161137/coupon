...
<html lang="en">
  <head>
    ...
    <link rel="shortcut icon" href="{{url('')}}/assets/img/favicon.png?v=3">
    ...
    <link rel="stylesheet" href="{{url('')}}/assets/css/style.light-blue-500.min.css">
    <!--[if lt IE 9]>
    ...
    <div class="ms-site-container">
      ...
      <header class="ms-header ms-header-primary">
        ...
        <div class="container container-full">
          <div class="ms-title">
            <a href="home">
              <!-- <img src="{{url('')}}/assets/img/demo/logo-header.png" alt=""> -->
              <img src="{{url('')}}/images/ahs-logo-eng.png" width="120">
            </a>
            <br>
          </div>
                  ...
                  <div class="media">
                    <div class="media-left media-middle">
                      <a href="javascript:void(0)">
                        <img class="media-object media-object-circle" src="{{url('')}}/{{url('')}}/assets/img/demo/p75.jpg" alt="..."> </a>
                    </div>
