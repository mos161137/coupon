        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-12 col-lg-6 order-1 order-lg-2">
                    <img src="{{url('')}}/thecharity/images/welcome.jpg" alt="welcome">
                </div><!-- .col -->
            </div><!-- .row -->
        </div><!-- .container -->
            ...
            <div class="row">
                <div class="col-12 col-md-6 col-lg-5">
                    <div class="testimonial-cont">
                        ...
                        <div class="entry-footer d-flex flex-wrap align-items-center mt-5">
                            <img src="{{url('')}}/thecharity/images/testimonial-1.jpg" alt="">
                ...
                <div class="col-12 col-md-6 offset-lg-2 col-lg-5">
                    <div class="testimonial-cont">
                        ...
                        <div class="entry-footer d-flex flex-wrap align-items-center mt-5">
                            <img src="{{url('')}}/thecharity/images/testimonial-2.jpg" alt="">
