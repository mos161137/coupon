            ...
            <div class="row portfolio-container">
                <div class="col-12 col-md-6 col-lg-4 portfolio-item">
                    <div class="portfolio-cont">
                        <a href="#"><img src="{{url('')}}/thecharity/images/a.jpg" alt=""></a>
                ...
                <div class="col-12 col-md-6 col-lg-3 portfolio-item">
                    <div class="portfolio-cont">
                        <a href="#"><img src="{{url('')}}/thecharity/images/b.jpg" alt=""></a>
                ...
                <div class="col-12 col-md-6 col-lg-5 portfolio-item">
                    <div class="portfolio-cont">
                        <a href="#"><img src="{{url('')}}/thecharity/images/c.jpg" alt=""></a>
                ...
                <div class="col-12 col-md-6 col-lg-5 portfolio-item">
                    <div class="portfolio-cont">
                        <a href="#"><img src="{{url('')}}/thecharity/images/d.jpg" alt=""></a>
                ...
                <div class="col-12 col-md-6 col-lg-3 mt-48 portfolio-item">
                    <div class="portfolio-cont">
                        <a href="#"><img src="{{url('')}}/thecharity/images/e.jpg" alt=""></a>
                ...
                <div class="col-12 col-md-6 col-lg-4 mt-48 portfolio-item">
                    <div class="portfolio-cont">
                        <a href="#"><img src="{{url('')}}/thecharity/images/f.jpg" alt=""></a>
                ...
                <div class="col-12 col-md-6 col-lg-3 mt-72 portfolio-item">
                    <div class="portfolio-cont">
                        <a href="#"><img src="{{url('')}}/thecharity/images/g.jpg" alt=""></a>
                ...
                <div class="col-12 col-md-6 col-lg-6 mt-72 portfolio-item">
                    <div class="portfolio-cont">
                        <a href="#"><img src="{{url('')}}/thecharity/images/h.jpg" alt=""></a>
                ...
                <div class="col-12 col-md-6 col-lg-3 mt-72 portfolio-item">
                    <div class="portfolio-cont">
                        <a href="#"><img src="{{url('')}}/thecharity/images/i.jpg" alt=""></a>
